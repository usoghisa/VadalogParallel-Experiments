...
public class StrongLink {
	...
	public StrongLink(String inputPerson, String inputKeyPerson, String inputCompany, String inputControl) {
		super();
	...
	private Dataset<String> withFlatMapGroup(Dataset<Row> keyPerson,
		...
		StrongLinkCoGroup pscCoGroup = new StrongLinkCoGroup(bControl, bPerson);
