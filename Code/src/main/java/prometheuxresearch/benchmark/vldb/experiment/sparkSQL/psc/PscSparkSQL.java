package prometheuxresearch.benchmark.vldb.experiment.sparkSQL.psc;
...
public class PscSparkSQL {
	...
	public static long run(Map<String, String> properties) {
		...
		long countPSCResult = pscResult.count();

		System.out.println("The number of psc relationships found is " + countPSCResult);
