...
public class CoGroupDeduplicationFunction implements
		CoGroupFunction<Tuple4<String, String, String, String>, Tuple4<String, String, String, String>, Tuple4<String, String, String, String>> {

	private static final long serialVersionUID = 4362283381685712069L;

	@Override
	public void coGroup(Iterable<Tuple4<String, String, String, String>> first,
			Iterable<Tuple4<String, String, String, String>> second,
			Collector<Tuple4<String, String, String, String>> out) throws Exception {

		Set<String> generatedFacts = new HashSet<>();
		Iterator<Tuple4<String, String, String, String>> iter = second.iterator();
		while (iter.hasNext()) {
		...
		iter = first.iterator();
		while (iter.hasNext()) {
			Tuple4<String, String, String, String> nextT = iter.next();
